...
/**
 * Session-stage share dock: pen outside stage, copy/mail/text in stage,
 * comment (and optional extras) slide over actions.
 */
export function ShareDeck({
  ...
  /** Extra controls under the comment field (e.g. session share scope). */
  editExtras?: ReactNode | ((ctx: { commentOpen: boolean }) => ReactNode);
  ...
  const dialogLabel = editAriaLabel ?? labels.commentField;
        ...
        <div className="flex min-w-0 w-full" style={{ gap: 8 }}>
          ...
          >
            <span
              ...
              style={{
                width: SHEET_FOOTER_ICON_SIZE,
                height: SHEET_FOOTER_ICON_SIZE,
              }}
            >
              {saveFlash ? (
