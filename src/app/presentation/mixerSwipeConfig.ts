...
export const MIXER_SWIPE_ARROW_IDLE = "#585878";
export const MIXER_SWIPE_STEP_IDLE = "#424260";
export const MIXER_DRAG_OVERLAY_HIDE_MS = 320;
export const MIXER_DRAG_BLOCKED_MS = 120;
export const MIXER_CARD_LIMIT_FLASH_TINT_PCT = 50;
export const MIXER_BUCKET_LIMIT_COLOR = "#c95868";
export const MIXER_BUCKET_LIMIT_VIBRATE_MS = [10, 28, 10] as const;
export const MIXER_DRAG_FOCUS_Z = 5;

export const MIXER_SWIPE_SURFACE_BASE = "#09091a";
export const MIXER_SWIPE_ZONE_ACTIVE_PCT = 3.5;
export const MIXER_SWIPE_STRIPE_A_PCT = 2;
export const MIXER_SWIPE_STRIPE_B_PCT = 0.8;

export const MIXER_ENTITY_BORDER_W = "1.5px";
export const MIXER_ENTITY_BORDER_ACTIVE = "aa";
