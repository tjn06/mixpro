...
export function getLightHighContrastCssEntries(): [string, string][] {
  ...
  const component: [string, string][] = [
    ...
    [componentCssVarNames.stripNeutral, hcPaper.input],
    [componentCssVarNames.stripMoreOpen, hcPaper.strip550],
    [componentCssVarNames.stripRename, hcPaper.strip450],
    [componentCssVarNames.stripDelete, hcPaper.strip400],
    [componentCssVarNames.stripOpen, hcPaper.strip600],
