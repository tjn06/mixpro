...
export function buildThemeCssEntries(
  ...
  const semantic: [string, string][] = [
    ...
    [componentCssVarNames.surfaceSheetDock, surfaces.sheetDock],
    [componentCssVarNames.surfaceSheetBody, surfaces.sheetBody],
  ...
  const component: [string, string][] = [
    ...
    [componentCssVarNames.textBtnBg, "transparent"],
    [componentCssVarNames.textBtnBorder, "none"],
    [componentCssVarNames.textBtnColor, text.secondary],
    [componentCssVarNames.textBtnColorActive, text.primary],
